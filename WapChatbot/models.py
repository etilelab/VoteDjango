...
class Question(models.Model):
    ...
    question_info = models.CharField(max_length=600) # 투표 설명
    question_flag = models.BooleanField() # 투표 종료 여부
    question_overlap = models.BooleanField() # 투표 중복 여부
    question_pub_date = models.DateTimeField('date published') # 투표 생성일
